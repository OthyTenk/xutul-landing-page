const QpayCard = ({ title, description }) => {
  return (
    <div className="flex mt-8">
      <div
        className={`p-8 border-[#eee] rounded-2xl bg-white border hover:-mt-2 hover:mb-2 flex flex-col items-center justify-center hover:shadow-md duration-300 w-full $`}
      >
